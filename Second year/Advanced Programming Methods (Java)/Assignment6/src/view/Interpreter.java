...
public class Interpreter {
    private static ProgramState checkedProgramState(Statement program) {
        program.typecheck(new MyDictionary<>());
        return new ProgramState(new StackExecutionStack(), new MapSymbolTable(), new ListOut(), new MapFileTable(), program);
    }
    ...
    public static void main(String[] args) {
        ...
        ProgramState prg1 = checkedProgramState(ex1);
        ...
        ProgramState prg2 = checkedProgramState(ex2);
        ...
        ProgramState prg3 = checkedProgramState(ex3);
        ...
        ProgramState prg4 = checkedProgramState(ex4);
        ...
        ProgramState prg5 = checkedProgramState(ex5);
        ...
        ProgramState prg6 = checkedProgramState(ex6);
        ...
        ProgramState prg7 = checkedProgramState(ex7);
        ...
        ProgramState prg8 = checkedProgramState(ex8);
        ...
        ProgramState prg9 = checkedProgramState(ex9);
        ...
        ProgramState prg10 = checkedProgramState(ex10);
